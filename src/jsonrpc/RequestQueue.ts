import { CsharpLSPRequest } from './csharpRequests';
...
class RequestQueue {
  ...
  public constructor(
    ...
    private _makeRequest: (request: CsharpLSPRequest) => number,
    /* tslint:enable */
  ) {}
   ...
   */
  public enqueue(request: CsharpLSPRequest) {
  ...
  public cancelRequest(request: CsharpLSPRequest) {
