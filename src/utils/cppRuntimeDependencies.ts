...
export default [
  ...
  },
  {
    ...
    platforms: ["linux"],
    architectures: ["x86_64"],
    binaries: ["./LLVM/bin/clang-format"]
  },
  {
  ...
  },
  {
    ...
    platforms: ["darwin"],
    binaries: ["./LLVM/bin/clang-format.darwin"]
  },
  {
  ...
  },
  {
    ...
    platforms: ["linux"],
    architectures: ["x86", "i686", "i386"],
    binaries: ["./debugAdapters/mono.linux-x86"]
  },
  {
